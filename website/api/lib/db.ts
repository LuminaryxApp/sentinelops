/**
 * Turso database client for Vercel serverless functions
 * Shares the same database as the main SentinelOps app
 */
...
export async function ensureAuthTables() {
  ...
  // Chat messages (linked to cloud_chats)
  await client.execute(`
  ...
  // Rate limiting for anonymous/free users
  await client.execute(`
